...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                         <li class="nav-item">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="/ps3">PS3</a>
                                  ...
                                  <a class="dropdown-item" href="/nintendo_switch">Nintendo Switch</a>
                                </div>
                              </div>
                         </li>
                         <li class="nav-item">
                         ...
                         <form class="form-inline ml-2" method="post" action="/search">
                            {{ csrf_field() }}
    ...
    <a href="/admin" class="btn btn-primary ml-3">Admin Panal</a>
        <br>
        @endif
    @endif
